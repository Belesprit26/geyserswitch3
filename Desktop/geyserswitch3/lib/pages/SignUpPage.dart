...
class _SignUpPageState extends State<SignUpPage> {
          ...
          try {
            ...
            switch (e.code) {
              ...
              case 'user-disabled':
                ...
                break;
              case 'user-not-found':
                message = "There is no user registered with this email and password";
                break;
              ...
              case "operation-not-allowed":
                ...
                break;
              case 'wrong-password':
                message = "The password entered does not match the email address/incorrect password";
                break;
            }
  ...
  Widget textItem2(String labelText, TextEditingController controller,
      bool obscureText) {
    return Container(
      width: MediaQuery
          .of(context)
  ...
  Widget textItem3(String labelText, TextEditingController controller,
      bool obscureText) {
    return Container(
      width: MediaQuery
          .of(context)
